...
verify that every language in some class A in MLRegTest belongs to A
...
recipe because \citeauthor{adil23} used a preliminary version of
\textsc{MLRegTest}, and we used the published
version.\footnote{MLRegTest is publicly available with Dryad
  \url{https://doi.org/10.5061/dryad.dncjsxm4h} under the license
  \emph{CC0 1.0 Universal (CC0 1.0) Public Domain Dedication}
...
We use the same non-parametric methods as \citet{mlregtest} and
\citet{adil23} in our analysis as advocated by \citet{Demsar2006} and
\citet{Stapor2017}. We report aggregate accuracy for the models as the
primary measurement of performance since the test sets are balanced,
and very strong correlations were found across performance
measures. Experimental observations are aggregated over the variables
...
great as was reported for the neural models in earlier research. To
